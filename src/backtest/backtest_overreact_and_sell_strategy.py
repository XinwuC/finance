...
def before_trading_start(context, data):
    ...
    print('Backtesting for date %s: Cash: $%.2f, Portfolio: $%.2f' % (
...
if __name__ == '__main__':
    perf = zipline.run_algorithm(start=datetime.datetime(2017, 7, 1).replace(tzinfo=pytz.UTC),
                                 end=datetime.datetime(2017, 11, 16).replace(tzinfo=pytz.UTC),
